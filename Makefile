...
download:
	./src-tauri/binaries/ytdown-aarch64-apple-darwin --proxy socks5://127.0.0.1:1095 --force-overwrites  -x -f "worstaudio[ext=webm]" --extract-audio --audio-format wav --postprocessor-args "-ar 16000 -ac 1" -o /Users/bruce/Library/Caches/newscenter1/temp.wav $(url)
...
check:
	./src-tauri/binaries/ytdown-aarch64-apple-darwin --proxy socks5://127.0.0.1:1095 --list-subs $(url)
