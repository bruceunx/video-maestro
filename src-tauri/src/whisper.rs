...
fn get_system_prompt(language: &str) -> String {
    let prompt = match language {
        ...
        El formato de salida para la explicación detallada es:
        ...
        Le format de sortie pour l'explication détaillée est :
        ...
        Das Ausgabeformat für die detailliertere Erläuterung ist:
        ...
        The final output's summary section should be formatted as follows:
        ## Summary:
        ...
        Based on each chapter's content, determine if a more detailed explanation is needed. This detailed explanation should appear after the summary.
        The output format for the detailed explanation is:
